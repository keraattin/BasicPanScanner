...
func exportCSV(filename string) error {
	...
	// Summary section
	writer.Write([]string{"BasicPanScanner Report - Version 2.0.0"})
	writer.Write([]string{""})
...
<head>
    ...
    <title>PAN Scanner Report - BasicPanScanner v2.0.0</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            ...
            <div class="version">Version 2.0.0 | PCI Compliance Scanner</div>
        </div>
	...
	html.WriteString(`
        ...
        <footer>
            <p><strong>BasicPanScanner v2.0.0</strong> | PCI Compliance Tool</p>
...
func exportTXT(filename string) error {
	...
	// Footer
	content.WriteString(strings.Repeat("═", 60) + "\n")
	content.WriteString("Report generated by BasicPanScanner v2.0.0\n")
